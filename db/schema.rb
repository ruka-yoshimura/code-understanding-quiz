...
ActiveRecord::Schema[7.1].define(version: 2026_02_06_170440) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "name"
    t.integer "daily_quiz_generation_count", default: 0, null: false
    t.datetime "last_quiz_generated_at"
